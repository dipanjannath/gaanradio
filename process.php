...
$your_email = "support@technomakes.com"; // email address to which the form data will be sent
$subject = "Message from TESWEB"; // subject of the email that is sent
$thanks_page = "thankyou.html"; // path to the thank you page following successful form submission
$contact_page = "index.php"; // path to the HTML contact page where the form appears
